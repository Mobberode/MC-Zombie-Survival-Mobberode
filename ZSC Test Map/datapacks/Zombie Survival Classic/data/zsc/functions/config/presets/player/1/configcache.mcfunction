...
execute store result score #CFGP1 zsc.config.player.mob.scaling run scoreboard players get #Score zsc.config.player.mob.scaling
execute store result score #CFGP1 zsc.config.wave.rank run scoreboard players get #Score zsc.config.wave.rank
#
execute store result score #CFGP1 zsc.config.mob.list run scoreboard players get #Score zsc.config.mob.list
execute store result score #CFGP1 zsc.config.spawning.system.type run scoreboard players get #Score zsc.config.spawning.system.type
execute store result score #CFGP1 zsc.config.unused.mobs run scoreboard players get #Score zsc.config.unused.mobs
