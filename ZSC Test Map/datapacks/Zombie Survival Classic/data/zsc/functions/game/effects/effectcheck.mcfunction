...
execute if score #Score zs.wave >= #Wave zsc.dconfig.mobeffects.wave if score #Score zsc.difficulty matches 0 if score #Score zsc.dconfig.effect.type matches 1 unless score #Score zsc.dconfig.mobeffects.wave matches -1 run function zsc:game/effects/zsc/list
execute if score #Score zs.wave >= #Wave zsc.dconfig.mobeffects.wave if score #Score zsc.difficulty matches 0 if score #Score zsc.dconfig.effect.type matches 2 unless score #Score zsc.dconfig.mobeffects.wave matches -1 run function zsc:game/effects/zsm/list
