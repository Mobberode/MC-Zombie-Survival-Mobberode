...
execute if score #Score1 zsc.rng matches ..49 if score #Chance1 zsc.rng matches 0..5 run data modify storage minecraft:zsc.macro e1 set value sharpness
execute if score #Score1 zsc.rng matches 50.. if score #Chance1 zsc.rng matches 0..5 run data modify storage minecraft:zsc.macro e1 set value bane_of_arthropods
#2
execute store result score #Score2 zsc.rng run random value 0..100
execute if score #Score2 zsc.rng matches 0..64 if score #Chance2 zsc.rng matches 0..5 run data modify storage minecraft:zsc.macro e2 set value knockback
execute if score #Score2 zsc.rng matches 65.. if score #Chance2 zsc.rng matches 0..5 run data modify storage minecraft:zsc.macro e2 set value fire_aspect
#3
