...
execute if score @s zsc.gear_mgp_weapon matches 3 if score #Score1 zsc.rng matches 50.. if score #Chance1 zsc.rng matches 0.. run data modify storage minecraft:zsc.macro e1 set value flame
#1 (Crossbow)
execute if score @s zsc.gear_mgp_weapon matches 4 if score #Score1 zsc.rng matches ..100 if score #Chance1 zsc.rng matches 0.. run data modify storage minecraft:zsc.macro e1 set value piercing
#1 (Trident)
...
execute if score @s zsc.gear_mgp_weapon matches 3 if score #Score2 zsc.rng matches 66..100 if score #Chance2 zsc.rng matches 0.. run data modify storage minecraft:zsc.macro e2 set value punch
#2 (Crossbow)
execute if score @s zsc.gear_mgp_weapon matches 4 if score #Score2 zsc.rng matches ..100 if score #Chance2 zsc.rng matches 0.. run data modify storage minecraft:zsc.macro e2 set value multishot
#3
execute store result score #Score3 zsc.rng run random value 0..100
execute if score #Score3 zsc.rng matches 0..100 if score #Chance3 zsc.rng matches 0..0 run data modify storage minecraft:zsc.macro e3 set value unbreaking
#3 (Crossbow)
