...
execute if score @s zsc.gear_mgp_weapon matches 3 if score #Score2 zsc.rng matches 66..100 if score #Chance2 zsc.rng matches ..100 run data modify storage minecraft:zsc.macro e2 set value punch
#2 (Crossbow)
