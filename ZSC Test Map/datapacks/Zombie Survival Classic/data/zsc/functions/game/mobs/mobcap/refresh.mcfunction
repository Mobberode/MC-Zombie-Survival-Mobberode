...
execute if score #Score zsc.difficulty matches 0 store result score #CustomMultiplier zsc.mob.amount.operation run scoreboard players get #CustomCache zsc.mob.amount.operation
