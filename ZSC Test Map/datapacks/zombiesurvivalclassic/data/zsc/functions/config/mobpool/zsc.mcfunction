...
##PVC on
execute unless score #Score zsc.config.player.vote.configs matches 0 unless entity @s[tag=voted.zscmoblist] run scoreboard players add #Score zsc.config.moblist.zsc.votes 1
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.zsmmoblist] unless entity @s[tag=voted.zsmoblist] run scoreboard players remove #Score zsc.config.moblist.zsm.votes 1
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.zsmoblist] unless entity @s[tag=voted.zsmmoblist] run scoreboard players remove #Score zsc.config.moblist.zs.votes 1
