...
##PVC on
execute unless score #Score zsc.config.player.vote.configs matches 0 unless entity @s[tag=voted.multiplydivide] run scoreboard players add #Score zsc.config.spawning.multiply.divide.votes 1
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.multiply] unless entity @s[tag=voted.fixed] run scoreboard players remove #Score zsc.config.spawning.multiply.votes 1
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.fixed] unless entity @s[tag=voted.multiply] run scoreboard players remove #Score zsc.config.spawning.fixed.votes 1
