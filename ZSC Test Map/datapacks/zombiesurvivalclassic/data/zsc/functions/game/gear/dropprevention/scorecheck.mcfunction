##if there's a difference. Start
execute unless entity @a[scores={zsc.gear.sword=0}] run function zsc:game/gear/dropprevention/detected
execute unless entity @a[scores={zsc.gear.bow=0}] run function zsc:game/gear/dropprevention/detected
execute unless entity @a[scores={zsc.gear.helmet=0}] run function zsc:game/gear/dropprevention/detected
