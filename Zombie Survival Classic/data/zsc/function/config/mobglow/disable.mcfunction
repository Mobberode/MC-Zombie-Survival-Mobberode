...
##PVC off
execute if entity @s[tag=mb.host] unless score #Score zsc.config.player.vote.configs matches 1 run scoreboard players set #Score zsc.config.mob.glow 0
...
##PVC on
execute unless score #Score zsc.config.player.vote.configs matches 0 unless entity @s[tag=voted.nomobglow] run scoreboard players add #Option2 zsc.config.mob.glow 1
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.yesmobglow] run scoreboard players remove #Option1 zsc.config.mob.glow 1
execute unless score #Score zsc.config.player.vote.configs matches 0 run tag @s remove voted.yesmobglow
