...
execute as @a[scores={zs.menu.section=9},team=!mb.base.alive] run function zsc:menu/spectator_actions
...
execute as @a[scores={zs.menu.interaction=2},tag=mb.host] if score #Score zs.game.status matches 1..2 run function zsc:lobby/timertoggle
#Configs Menu
