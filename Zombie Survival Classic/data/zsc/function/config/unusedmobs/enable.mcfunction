...
##PVC off
execute if entity @s[tag=mb.host] unless score #Score zsc.config.player.vote.configs matches 1 run scoreboard players set #Score zsc.config.unused.mobs 1
...
execute unless score #Score zsc.config.player.vote.configs matches 0 run tag @s add voted.yesunusedmobs
