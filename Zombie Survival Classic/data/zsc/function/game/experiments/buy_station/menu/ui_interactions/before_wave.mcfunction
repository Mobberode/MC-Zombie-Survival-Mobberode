...
execute as @a[scores={zs.menu.interaction=81331..81334},team=mb.base.alive,tag=zsc_experiment_buy_station.can_enter_shop] run function zsc:game/experiments/buy_station/menu/ui_interactions/gear/food/sort
