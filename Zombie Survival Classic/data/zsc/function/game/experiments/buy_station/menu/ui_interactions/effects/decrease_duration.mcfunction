...
execute unless score @s zsc.experiment_buy_station_effect_duration_increaser matches ..0 run scoreboard players remove @s zsc.experiment_buy_station_effect_cost 2
