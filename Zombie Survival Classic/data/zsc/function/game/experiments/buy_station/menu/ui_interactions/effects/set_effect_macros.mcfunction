execute store result storage minecraft:zsc.macro effect_timer int 1 run scoreboard players set #Time zsc.experiment_buy_station_effect_duration_increaser 30
