...
scoreboard players set @s zsc.experiment_buy_station_effect_type 10
...
execute as @s run function zsc:game/experiments/buy_station/menu/ui/effects/effects_buy