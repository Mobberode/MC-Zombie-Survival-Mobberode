...
$execute as @a[scores={zsc.players=$(zsc_experiment_buy_station_entry5)},team=zsc.waiting] run function zsc:game/experiments/buy_station/player/bought_back_waiting
