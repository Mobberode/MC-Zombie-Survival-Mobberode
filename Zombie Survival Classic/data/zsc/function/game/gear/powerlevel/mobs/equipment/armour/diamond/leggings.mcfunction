...
$execute if score #Chance4 zsc.rng matches $(enchant_chance) run item replace entity @s armor.legs with diamond_leggings[minecraft:enchantments={levels:{"$(e1)":$(l1),"$(e2)":$(l2),"$(e3)":$(l3)}}]
