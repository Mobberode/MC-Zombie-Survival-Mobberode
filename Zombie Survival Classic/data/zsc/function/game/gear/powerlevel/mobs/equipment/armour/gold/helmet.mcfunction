...
$execute if score #Chance4 zsc.rng matches $(enchant_chance) run item replace entity @s armor.head with golden_helmet[minecraft:enchantments={"$(e1)":$(l1),"$(e2)":$(l2),"$(e3)":$(l3)}]
