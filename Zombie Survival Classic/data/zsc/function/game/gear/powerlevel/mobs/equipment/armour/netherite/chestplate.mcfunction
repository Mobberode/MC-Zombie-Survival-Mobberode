...
$execute if score #Chance4 zsc.rng >= #EnchantChance zsc.gear_mgp_tier run item replace entity @s armor.chest with netherite_chestplate[minecraft:enchantments={"$(e1)":$(l1),"$(e2)":$(l2),"$(e3)":$(l3)}]
