...
$execute if score #Chance4 zsc.rng matches $(enchant_chance) run item replace entity @s armor.chest with netherite_chestplate[minecraft:enchantments={"$(e1)":$(l1),"$(e2)":$(l2),"$(e3)":$(l3)}]
