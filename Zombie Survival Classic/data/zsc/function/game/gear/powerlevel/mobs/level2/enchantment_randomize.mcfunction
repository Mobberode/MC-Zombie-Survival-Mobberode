...
execute if score #Score1 zsc.rng matches ..9 if score #Chance1 zsc.rng matches 0..1 run data modify storage zsc:macro e1 set value sharpness
execute if score #Score1 zsc.rng matches 10.. if score #Chance1 zsc.rng matches 0..1 run data modify storage zsc:macro e1 set value bane_of_arthropods
#2
execute store result score #Score2 zsc.rng run random value 0..100
execute if score #Score2 zsc.rng matches 0.. if score #Chance2 zsc.rng matches 0..1 run data modify storage zsc:macro e2 set value knockback
#3
execute store result score #Score3 zsc.rng run random value 0..100
execute if score #Score3 zsc.rng matches ..100 if score #Chance3 zsc.rng matches 0..1 run data modify storage zsc:macro e3 set value unbreaking
#Levels
