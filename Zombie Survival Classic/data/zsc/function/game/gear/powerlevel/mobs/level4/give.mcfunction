...
execute if score @s[tag=mgp_processed_bower,tag=mgp.wither_skeleton.using_bow] zsc.rng matches 30.. run function zsc:game/gear/powerlevel/mobs/equipment/weapon/bow with storage zsc:macro
