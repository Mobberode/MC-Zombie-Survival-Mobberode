...
#(3=Standard Iron)
execute if score #Score zsc.difficulty matches 0 if score #Player zsc.dconfig.gear.level matches 3 run function zsc:game/gear/powerlevel/players/standard with storage zsc:macro
#(4=Enchanted Iron)
execute if score #Score zsc.difficulty matches 0 if score #Player zsc.dconfig.gear.level matches 4 run function zsc:game/gear/powerlevel/players/pgl/level4 with storage zsc:macro
