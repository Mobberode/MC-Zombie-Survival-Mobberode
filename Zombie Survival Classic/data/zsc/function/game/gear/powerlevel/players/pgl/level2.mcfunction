...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with chainmail_helmet[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with chainmail_chestplate[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with chainmail_leggings[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with chainmail_boots[minecraft:unbreakable={}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with stone_sword[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received] hotbar.1 with bow[minecraft:unbreakable={}]
execute if score #Score zsc.config.give.players.shields matches 1 run item replace entity @a[tag=!zsc.received] weapon.offhand with shield[enchantments= {"minecraft:unbreaking": 2}]
