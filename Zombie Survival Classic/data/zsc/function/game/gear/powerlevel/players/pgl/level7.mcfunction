...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with netherite_helmet[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with netherite_chestplate[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with netherite_leggings[minecraft:unbreakable={}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with netherite_boots[minecraft:unbreakable={}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with netherite_sword[minecraft:unbreakable={}]
