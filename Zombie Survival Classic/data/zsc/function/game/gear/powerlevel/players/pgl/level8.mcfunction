...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with netherite_helmet[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels:{"projectile_protection":1}}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with netherite_chestplate[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels:{"blast_protection":1}}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with netherite_leggings[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels:{"protection":1}}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with netherite_boots[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels:{"fire_protection":1}}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with netherite_sword[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels: {"sharpness":2,"sweeping_edge":2}}]
item replace entity @a[tag=!zsc.received] hotbar.1 with bow[minecraft:unbreakable={unbreakable:true},minecraft:enchantments={levels: {"power":3,"multishot":1}}]
