...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with netherite_helmet[minecraft:unbreakable={},minecraft:enchantments={"projectile_protection":1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with netherite_chestplate[minecraft:unbreakable={},minecraft:enchantments={"blast_protection":1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with netherite_leggings[minecraft:unbreakable={},minecraft:enchantments={"protection":1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with netherite_boots[minecraft:unbreakable={},minecraft:enchantments={"fire_protection":1}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with netherite_sword[minecraft:unbreakable={},minecraft:enchantments={"sharpness":2,"sweeping_edge":2}]
item replace entity @a[tag=!zsc.received] hotbar.1 with bow[minecraft:unbreakable={},minecraft:enchantments={"power":3,"multishot":1}]
