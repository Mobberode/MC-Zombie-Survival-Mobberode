...
#Time Indicate
title @a actionbar ["Pre-Game Intermission: ",{score:{name:"#Score",objective:"zs.timer"}},".",{score:{name:"#MiliScore",objective:"zs.timer"}}," ",{score:{name:"#Skip",objective:"zsc.players"},color:blue},"/",{score:{name:"#Score",objective:"zsc.players"},color:blue}]
