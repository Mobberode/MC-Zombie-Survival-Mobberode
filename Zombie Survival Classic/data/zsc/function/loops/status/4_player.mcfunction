...
execute if entity @s[team=mb.base.alive] if score #Config zsc.experiment_buy_station matches 1 run return run function zsc:game/experiments/buy_station/player/menu_give_condition
