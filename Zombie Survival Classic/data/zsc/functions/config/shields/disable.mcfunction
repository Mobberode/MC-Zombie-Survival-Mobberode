...
##PVC off
execute if entity @s[tag=host] unless score #Score zsc.config.player.vote.configs matches 1 run scoreboard players set #Score zsc.config.give.players.shields 0
...
execute unless score #Score zsc.config.player.vote.configs matches 0 if entity @s[tag=voted.gps.add] run scoreboard players remove #Option1 zsc.config.give.players.shields 1
execute unless score #Score zsc.config.player.vote.configs matches 0 run tag @s add voted.gps.false
execute unless score #Score zsc.config.player.vote.configs matches 0 run tag @s remove voted.gps.add
