...
#ZS Testers
tag @a[tag=Has.ZS.Testers,scores={zs.player.config.role=2}] remove ZS.OGs
tag @a[tag=Has.ZS.Testers,scores={zs.player.config.role=2}] add ZS.Testers
tag @a[tag=Has.ZS.Testers,scores={zs.player.config.role=2}] remove Developers
tag @a[tag=Has.ZS.Testers,scores={zs.player.config.role=2}] remove Curated
#Developers
