execute unless score @s zsc.experiment_buy_station_effect_duration_increaser matches ..0 store result storage minecraft:zsc.macro effect_timer int 1 run scoreboard players add #Time zsc.experiment_buy_station_effect_duration_increaser 30
