...
$execute if score #Chance4 zsc.rng matches 0..99 run item replace entity @s armor.legs with chainmail_leggings{Enchantments:[{id:"$(e1)",lvl:$(l1)},{id:"$(e2)",lvl:$(l2)},{id:"$(e3)",lvl:$(l3)}]}
