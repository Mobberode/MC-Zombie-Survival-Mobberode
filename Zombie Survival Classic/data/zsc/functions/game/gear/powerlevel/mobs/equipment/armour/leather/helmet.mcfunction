...
$execute if score #Chance4 zsc.rng matches $(enchant_chance) run item replace entity @s armor.head with leather_helmet{Enchantments:[{id:"$(e1)",lvl:$(l1)},{id:"$(e2)",lvl:$(l2)},{id:"$(e3)",lvl:$(l3)}]}
