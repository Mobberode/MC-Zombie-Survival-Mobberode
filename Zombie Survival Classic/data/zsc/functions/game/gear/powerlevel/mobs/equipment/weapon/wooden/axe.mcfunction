...
$execute if score #Chance4 zsc.rng matches 0..15 run item replace entity @s weapon.mainhand with wooden_axe{Enchantments:[{id:"$(e1)",lvl:$(l1)},{id:"$(e2)",lvl:$(l2)},{id:"$(e3)",lvl:$(l3)}]}
