...
#Misc
execute if score @s[tag=mgp_processed_bower] zsc.rng matches 5.. run function zsc:game/gear/powerlevel/mobs/equipment/weapon/bow with storage minecraft:zsc.macro
