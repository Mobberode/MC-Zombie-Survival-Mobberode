...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with leather_helmet[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with leather_chestplate[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with leather_leggings[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with leather_boots[minecraft:unbreakable={unbreakable:1}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with wooden_sword[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received] hotbar.1 with bow[minecraft:unbreakable={unbreakable:1}]
execute if score #Score zsc.config.give.players.shields matches 1 run item replace entity @a[tag=!zsc.received] weapon.offhand with shield[enchantments= {levels: {"minecraft:unbreaking": 1}}]
