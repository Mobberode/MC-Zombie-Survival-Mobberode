...
item replace entity @a[tag=!zsc.received] armor.head with leather_helmet{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.chest with leather_chestplate{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.legs with leather_leggings{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.feet with leather_boots{Unbreakable:1}
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with wooden_sword{Unbreakable:1}
...
execute unless score #ArmourTick zs.timer matches 0 run function zsc:game/gear/powerlevel/players/pgl/level1 with storage minecraft:zsc.macro