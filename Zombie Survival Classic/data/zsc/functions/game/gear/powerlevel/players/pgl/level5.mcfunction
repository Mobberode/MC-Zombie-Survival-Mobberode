...
item replace entity @a[tag=!zsc.received] armor.head with diamond_helmet{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.chest with diamond_chestplate{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.legs with diamond_leggings{Unbreakable:1}
item replace entity @a[tag=!zsc.received] armor.feet with diamond_boots{Unbreakable:1}
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with diamond_sword{Unbreakable:1}
...
execute unless score #ArmourTick zs.timer matches 0 run function zsc:game/gear/powerlevel/players/pgl/level5 with storage minecraft:zsc.macro