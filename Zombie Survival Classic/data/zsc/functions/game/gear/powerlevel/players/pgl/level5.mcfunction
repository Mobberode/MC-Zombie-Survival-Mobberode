...
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.head with diamond_helmet[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.chest with diamond_chestplate[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.legs with diamond_leggings[minecraft:unbreakable={unbreakable:1}]
item replace entity @a[tag=!zsc.received,tag=!zsc.gear.processed.role] armor.feet with diamond_boots[minecraft:unbreakable={unbreakable:1}]
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with diamond_sword[minecraft:unbreakable={unbreakable:1}]
