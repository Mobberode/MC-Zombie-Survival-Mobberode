...
item replace entity @a[tag=!zsc.received] armor.head with netherite_helmet{Unbreakable:1,Enchantments:[{id:"projectile_protection",lvl:1}]}
item replace entity @a[tag=!zsc.received] armor.chest with netherite_chestplate{Unbreakable:1,Enchantments:[{id:"blast_protection",lvl:1}]}
item replace entity @a[tag=!zsc.received] armor.legs with netherite_leggings{Unbreakable:1,Enchantments:[{id:"protection",lvl:1}]}
item replace entity @a[tag=!zsc.received] armor.feet with netherite_boots{Unbreakable:1,Enchantments:[{id:"fire_protection",lvl:1}]}
...
#Equipment
item replace entity @a[tag=!zsc.received] hotbar.0 with netherite_sword{Unbreakable:1,Enchantments:[{id:"sharpness",lvl:2},{id:"sweeping",lvl:2}]}
item replace entity @a[tag=!zsc.received] hotbar.1 with bow{Unbreakable:1,Enchantments:[{id:"power",lvl:3}]}
...
execute unless score #ArmourTick zs.timer matches 0 run function zsc:game/gear/powerlevel/players/pgl/level8 with storage minecraft:zsc.macro