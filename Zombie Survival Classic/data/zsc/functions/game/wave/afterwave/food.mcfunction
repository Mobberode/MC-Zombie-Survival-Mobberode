...
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 2 if score #Score zsc.config.food.type matches 0 run give @a[team=Alive] cooked_beef 2
#Rabbit Stew
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 4 if score #Score zsc.config.food.type matches 1 run give @a[team=Alive] rabbit_stew 4
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 3 if score #Score zsc.config.food.type matches 1 run give @a[team=Alive] rabbit_stew 2
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 2 if score #Score zsc.config.food.type matches 1 run give @a[team=Alive] rabbit_stew
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 2 if score #Score zsc.config.food.type matches 1 run give @a[team=Alive] rabbit_stew
