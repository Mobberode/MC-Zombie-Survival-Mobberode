...
execute if score #Score zsc.difficulty matches 0 if score #GetAmountType zsc.player.food.count matches 2 if score #Score zsc.config.food.type matches 1 run give @a rabbit_stew
