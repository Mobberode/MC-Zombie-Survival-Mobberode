...
##Normal
execute if score #Score zsc.team.lives matches ..0 unless entity @a[team=Alive] unless score #Score zsc.config.challenge.permadeath matches 1 unless score #Score zs.game.status matches 5 run function zsc:game/wave/gameover
...
#Permadeath
execute unless entity @a[team=Alive] if score #Score zsc.config.challenge.permadeath matches 1 unless score #Score zs.game.status matches 5 run function zsc:game/wave/gameover