...
execute if score @p zsct.page matches 6.. run scoreboard players set @s zsct.page -1
...
execute if score @p zsct.page matches -1 run function zsct:tools/givetools/give/creepersurvival
