...
scoreboard objectives add zsc.hard dummy
scoreboard objectives add zsc.normal dummy
scoreboard objectives add zsc.hard.votes dummy
scoreboard objectives add zsc.normal.votes dummy
scoreboard objectives add zsc.custom dummy
scoreboard objectives add zsc.custom.votes dummy
scoreboard objectives add zsc.begin.vote dummy
scoreboard objectives add zsc.host.only dummy
