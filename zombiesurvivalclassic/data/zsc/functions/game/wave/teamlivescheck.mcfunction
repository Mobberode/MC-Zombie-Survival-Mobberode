...
execute if score #Score zsc.team.lives matches 0..10 run team join Alive @a[team=Dead]
execute if score #Score zsc.team.lives matches 0..10 run tellraw @a {"text":"A Team Life has been used up!"}